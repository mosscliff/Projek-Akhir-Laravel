...
<div class="col-xs-12 col-sm-12 col-md-12">
    ...
    <input type="text" name="owner" value="{{ $company->owner }}" class="form-control" placeholder="Company owner">
    @error('owner')
    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
    @enderror
    </div>
...
<div class="col-xs-12 col-sm-12 col-md-12">
    ...
    <input type="text" name="product" value="{{ $company->product }}" class="form-control" placeholder="Company product">
    @error('product')
    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
    @enderror
    </div>
