...
<div class="col-xs-12 col-sm-12 col-md-12">
    ...
    <input type="text" name="owner" class="form-control" placeholder="Company owner">
...
<div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <input type="text" name="product" class="form-control" placeholder="Company Product">
...
</html><?php /**PATH D:\cobaauth\resources\views/companies/create.blade.php ENDPATH**/ ?>