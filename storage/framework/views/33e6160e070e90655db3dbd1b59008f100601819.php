...
<a class="btn btn-primary" href="<?php echo e(route('bolas.index')); ?>"> Back</a>
</div>
</div>
</div>
...
<?php endif; ?>
<form action="<?php echo e(route('bolas.store')); ?>" method="POST" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
<div class="row">
...
</html><?php /**PATH D:\cobaauth\resources\views/bolas/create.blade.php ENDPATH**/ ?>